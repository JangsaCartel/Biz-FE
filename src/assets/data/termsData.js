...
export const termsOfService = [
  ...
  },
  {
    ...
    content: `
      <ol>
        ...
        <li>회사가 약관을 변경할 경우에는 적용일자 및 변경사유를 명시하여 현행 약관과 함께 서비스 내 공지사항에 그 적용일자 7일 전부터 적용일자 전일까지 공지합니다. <strong>다만, 이용자에게 불리한 약관의 변경의 경우에는 30일 전부터 공지합니다.</strong></li>
  ...
  },
  {
    ...
    content: `
      <ol>
        ...
        <li>회사는 이용신청 요건을 충족하는 모든 이용자의 신청을 승낙함을 원칙으로 합니다. <strong>다만, 다음 각 호에 해당하는 신청에 대해서는 승낙을 하지 않거나 사후에 이용계약을 해지할 수 있습니다.</strong>
          <ul>
            <li>가입 신청자가 이 약관에 의하여 이전에 회원자격을 상실한 적이 있는 경우</li>
            <li>실명이 아니거나 타인의 명의를 이용한 경우</li>
            <li>허위의 정보를 기재하거나, 회사가 제시하는 내용을 기재하지 않은 경우</li>
            <li>이용자의 귀책사유로 인하여 승인이 불가능하거나 기타 규정한 제반 사항을 위반하며 신청하는 경우</li>
            <li>사회적 질서 및 미풍양속을 저해할 목적으로 신청한 경우</li>
          </ul>
        </li>
      </ol>`
  },
  {
    ...
    content: `
      <ol>
        ...
        <li>회원은 회원가입 시 기재한 사항이 변경되었을 경우 <strong>서비스 내 마이페이지 등을 통해 직접 수정해야 합니다.</strong></li>
        <li>제2항의 변경사항을 회사에 알리지 않아(직접 수정하지 않아) 발생한 불이익에 대하여 회사는 책임을 지지 않습니다.</li>
      </ol>`
  },
  {
    title: "제7조 (개인정보보호 의무)",
  ...
  {
    title: "제7조의 2 (AI 기술 활용 및 데이터 처리)",
    content: `
      <ol>
        <li>본 서비스는 사용자에게 최적화된 맞춤형 분석 및 추천 정보를 제공하기 위해 인공지능(AI) 기술을 활용합니다.</li>
        <li>회원이 입력한 닉네임, 지역, 상호명, 업종, 개업일자 등의 데이터는 AI 분석 모델의 학습 및 통계 처리에 활용될 수 있습니다.</li>
        <li><strong>서비스 제공을 위해 회원의 데이터는 Gemini 등 외부 AI 서비스 제공자에게 전송될 수 있습니다.</strong> 회원은 서비스 가입 시 이에 동의한 것으로 간주합니다.</li>
      </ol>`
  },
  {
      ...
      <ol>
        <li>회사는 다음과 같은 서비스를 제공합니다.
          <ul>
             ...
             <li>소상공인의 주변 지역을 지도를 통해 지역 소상공인끼리 게시글을 공유하는 서비스</li>
             <li>기타 회사가 추가 개발하거나 제휴 등을 통해 회원에게 제공하는 일체의 서비스</li>
          </ul>
        </li>
        <li>회사는 운영상, 기술상의 필요에 따라 제공하고 있는 서비스를 변경할 수 있으며, 이 경우 변경된 서비스의 내용 및 제공일자를 명시하여 사전에 공지합니다.</li>
  ...
  },
  {
    ...
    content: `
      <ol>
        <li>회사는 <strong>천재지변, 정보통신설비의 보수점검, 교체 및 고장, 통신의 두절, 국가비상사태</strong> 등 불가항력적인 사유가 발생한 경우에는 서비스의 제공을 일시적으로 중단할 수 있습니다.</li>
        <li>회사는 제1항의 사유로 서비스의 제공이 일시적으로 중단됨으로 인하여 이용자 또는 제3자가 입은 손해에 대하여 <strong>고의 또는 중대한 과실이 없는 한 배상하지 않습니다.</strong></li>
        <li>사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 회사는 제4조에 정한 방법으로 이용자에게 통지합니다.</li>
      </ol>`
  },
  {
    ...
    content: `
      <ol>
        <li>회원은 회사에 언제든지 탈퇴를 요청할 수 있으며 회사는 즉시 회원탈퇴를 처리합니다. <strong>회원 탈퇴 시 회원의 개인정보 및 활동 데이터는 즉시 영구 삭제되며 복구할 수 없습니다. 단, 제16조 제3항 및 관련 법령에 따라 일정 기간 보관해야 하는 정보는 예외로 합니다.</strong></li>
  ...
  },
  {
    ...
    content: `
      <ol>
        <li>회사는 전시, 사변, 천재지변 또는 이에 준하는 국가비상사태가 발생하거나 발생할 우려가 있는 경우와 기간통신사업자가 전기통신 서비스를 중지하는 등 기타 불가항력적 사유가 있는 경우에는 서비스의 전부 또는 일부를 제한하거나 중지할 수 있습니다.</li>
        <li>회사는 서비스 이용을 제한하거나 중지하는 때에는 그 사유 및 제한기간 등을 지체 없이 이용자에게 알립니다.</li>
      </ol>`
  },
  {
    title: "제16조 (게시물의 관리)",
    content: `
      <ol>
        ...
        <li><strong>회원이 직접 삭제를 요청한 게시글 및 댓글은 즉시 서비스 화면에서 비공개 처리됩니다. 다만, 법적 분쟁 대비 및 운영 정책(불량 이용자 제재 등)에 따라 필요한 경우 삭제 시점으로부터 1년간 보관 후 영구 삭제됩니다.</strong></li>
      </ol>`
  },
  {
    title: "제17조 (게시물의 저작권)",
  ...
  {
    title: "부칙",
    content: `<p>이 약관은 2026년 01월 23일부터 시행합니다.</p>`
  }
];
