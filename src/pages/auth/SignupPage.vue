      ...
      <div v-if="termsModalVisible" class="modal-overlay" @click.self="closeTermsModal">
        <div class="modal-content terms-modal">
          ...
          <div class="terms-body">
            <h3>제1조 (목적)</h3>
            <p>
              이 약관은 JangsaCartel(이하 "회사"라 함)이 제공하는 서비스의 이용과 관련하여 회사와
            ...
            <ol>
              ...
              <li>
                "콘텐츠"란 회사 또는 이용자가 서비스 상에 게시한 모든 글, 사진, 동영상, 첨부파일,
                링크 등을 말합니다.
              </li>
            </ol>
            ...
            <h3>제3조 (약관 외 준칙)</h3>
            <p>
              이 약관에서 정하지 아니한 사항은 전기통신사업법, 전자상거래 등에서의 소비자보호에 관한
              법률, 개인정보 보호법 등 관련 법령의 규정과 일반적인 상관례에 의합니다.
            </p>
            ...
            <ol>
              ...
              <li>
                회사가 약관을 변경할 경우에는 적용일자 및 변경사유를 명시하여 현행 약관과 함께
                서비스 내 공지사항에 그 적용일자 7일 전부터 적용일자 전일까지 공지합니다. 다만,
                이용자에게 불리한 약관의 변경의 경우에는 30일 전부터 공지합니다.
              </li>
              <li>
                이용자는 변경된 약관에 동의하지 않을 경우 서비스 이용을 중단하고 회원 탈퇴를 요청할
                수 있습니다. 변경된 약관의 효력 발생일 이후에도 서비스를 계속 이용할 경우 약관의
                변경사항에 동의한 것으로 간주됩니다.
              </li>
            </ol>
            ...
            <ol>
              <li>
                이용계약은 이용자가 이 약관에 동의하고 회사가 정한 가입 양식에 따라 회원정보를
                기입한 후 가입을 신청하고, 회사가 이를 승낙함으로써 체결됩니다.
              </li>
              <li>
                회사는 이용신청 요건을 충족하는 모든 이용자의 신청을 승낙합니다. 다만, 회사는 다음
                각 호에 해당하는 신청에 대해서는 승낙을 하지 않거나 사후에 이용계약을 해지할 수
                있습니다.
              </li>
            </ol>
            ...
            <ol>
              <li>
                본 서비스는 사용자에게 최적화된 맞춤형 분석 및 추천 정보를 제공하기 위해
                인공지능(AI) 기술을 활용합니다.
              </li>
              <li>
                회원이 입력한 닉네임, 지역, 상호명, 업종, 개업일자 등의 데이터는 AI 분석 모델의 학습
                및 통계 처리에 활용될 수 있으며, 이는 개인을 식별할 수 없는 형태로 안전하게
                처리됩니다. 회원은 서비스 가입 시 이에 동의한 것으로 간주합니다.
              </li>
            </ol>
            ...
            <p>
              2. 이용자는 관계법령, 이 약관의 규정, 이용안내 및 서비스와 관련하여 공지한 주의사항,
            ...
            <ol>
              ...
              <li>
                회사는 이용자에게 서비스를 제공함에 있어 관련 법령, 약관, 운영정책 및 공지사항
                등에서 정한 바에 따라 무료로 서비스를 제공합니다.
              </li>
            </ol>
            ...
            <ol>
              ...
              <li>
                ...
                되는 경우에는 회사는 제4조에 정한 방법으로 이용자에게 통지하고 당초 회사에서 제시한
                조건에 따라 소비자에게 보상합니다.
              </li>
            </ol>
            ...
            <ol>
              <li>
                ...
                <strong
                  >단, 회원 탈퇴 시 회원의 개인정보 및 활동 데이터는 즉시 영구 삭제되며 복구할 수
                  없습니다.</strong
                >
              </li>
              <li>
            ...
            <p>
              회사는 회원에게 서비스 이용에 필요한 정보를 공지사항이나 전자우편 등의 방법으로 제공할
              수 있습니다. 다만, 회사는 회원이 동의하지 않는 한 영리목적의 광고성 정보를 제공하지
              않습니다.
            </p>
            ...
            <ol>
              <li>
                회사는 전시, 사변, 천재지변 또는 이에 준하는 국가비상사태가 발생하거나 발생할 우려가
                있는 경우와 전기통신사업법에 의한 기간통신사업자가 전기통신 서비스를 중지하는 등
                기타 불가항력적 사유가 있는 경우에는 서비스의 전부 또는 일부를 제한하거나 중지할 수
                있습니다.
              </li>
              <li>
                회사는 제1항에 의한 서비스 중단의 경우에는 상당한 기간 내에 그 사유를 공지하고,
                사전에 공지할 수 없는 부득이한 사유가 있는 경우에는 사후에 공지합니다.
              </li>
            </ol>
            ...
            <ol>
              <li>
                회원의 게시물이 관련 법령, 본 약관에 위반되거나 타인의 권리를 침해한다고 판단되는
                경우, 회사는 관련 법령에 따라 해당 게시물에 대한 접근을 임시적으로 차단하거나 삭제할
                수 있습니다.
              </li>
              <li>
                회사가 제1항에 따라 회원의 게시물을 삭제하거나 게시 중단 조치를 취하는 경우, 회사는
                해당 조치의 사유를 회원에게 통지합니다. 다만, 긴급한 경우에는 사후에 통지할 수
                있습니다.
              </li>
              <li>
                <strong
                  >회원이 직접 삭제를 요청한 게시글 및 댓글은 즉시 서비스 화면에서 비공개 처리되며,
                  법적 분쟁 및 불량 이용자 제재를 위한 운영 정책에 따라 삭제 시점으로부터 1년간 보관
                  후 영구 삭제 됩니다.</strong
                >
              </li>
            </ol>
            ...
            <ol>
              ...
              <li>
                회원이 서비스 내에 게시하는 게시물은 검색결과 내지 서비스 및 관련 프로모션 등에
                노출될 수 있으며, 해당 노출을 위해 필요한 범위 내에서는 일부 수정, 복제, 편집되어
                게시될 수 있습니다.
              </li>
              <li>
                회사는 회원의 명시적인 동의 없이 회원의 게시물을 상업적으로 이용하지 않습니다.
              </li>
              <li>
                회원은 언제든지 서비스 내 관리기능을 통해 자신의 게시물에 대해 삭제, 수정, 비공개
                등의 조치를 취할 수 있습니다.
              </li>
            </ol>
